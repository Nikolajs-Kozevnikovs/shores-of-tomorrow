namespace WorldOfZuul
{
    public class Room
    {
        ...
        public static Room Ocean = new Room('O', "Ocean", "You are in the middle of the vast ocean. The water stretches out in all directions, with no land in sight.");
        public static Room CoralReef = new Room('C', "Coral Reef", "You find yourself amidst a vibrant coral reef, teeming with colorful fish and marine life.");
        public static Room SeaShore = new Room('S', "Sea Shore", "You stand on a sandy sea shore, with gentle waves lapping at your feet and the salty breeze in the air.");
        public static Room House = new Room('H', "House", "You are inside a cozy house, bla bla bla");
        public static Room Boat = new Room('B', "Boat", "You are on a small boat, gently rocking on the waves.");
        public static Room Lake = new Room('L', "Lake", "You are at a serene lake, surrounded by trees and mountains."); // CloseLake, illegal fishing
        public static Room MarineLaboratory = new Room('M', "Marine Laboratory", "You are in a high-tech marine laboratory, filled with equipment and research materials.");
        public static Room RecyclingCentre = new Room('R', "Recycling Centre", "You are at a recycling centre, where waste is processed and sorted.");
        public static Room Townhall = new Room('T', "Townhall", "You are in the townhall, a place for community meetings and events.");
        public static Room Lake2 = new Room('W', "Lake 2", "You are at another peaceful lake, with clear water and abundant wildlife."); // Further away, legal fishing
        public static Room OldMansHouse = new Room('X', "Old Man's House", "bla bla bla");
        public static Room Factory = new Room('F', "Factory", "You are in a bustling factory, with machines whirring and workers busy at their tasks.");
        public static Room Blank = new Room('-', "Blank", "You are in an empty space, nothing to see here.");

        private char[][] Rooms = new char[][] {
            /* ---TILE IDENTIFIERS:---
            ...
            */
            new char[] {'O','O','O','O','O','O','C'},
            new char[] {'O','O','O','O','O','O','O'},
            new char[] {'O','O','O','O','O','O','O'},
            new char[] {'O','O','O','B','O','O','O'},
            new char[] {'S','S','S','S','S','S','S'},
            new char[] {'H','-','-','-','-','-','R'},
            new char[] {'L','M','-','T','-','-','-'},
            new char[] {'F','-','-','-','-','X','W'},
        };
